...
const fs = require('fs'); //imports i/o
...
model.fit(trainingTensor, outputTensor, { epochs: 200, verbose: 0, batchSize: 8, showMetric: true })
    ...
    // here, i put runDiscordBot() instead of runDiscordBot and runDiscordBot() actually executes before model.fit. you should instead pass a function
// otherwise the predictions WILL NOT work correctly!!!!
model.save('file://./TFModel');// only works when you require tfjs-node
